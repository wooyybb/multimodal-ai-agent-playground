class PromptCompiler:
    ...
    def run(self, state: dict) -> dict:
        ...
        if provider == "gpt_image":
            positive, notes, target_words = self._compile_gpt_image(prompt_blocks)
        elif provider == "sdxl":
            positive, notes, target_words = self._compile_sdxl(prompt_blocks)
        else:
            positive, notes, target_words = self._compile_flux(prompt_blocks)
            provider = "flux"
        ...
        package = {
            ...
            "prompt_budget": {
                ...
                "actual_words": len(positive.split()),
            },
        }
        ...
        return {"compiled_prompt_package": package}
